          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                 index==0?Icon(Icons.border_all_sharp,color: Colors.red,size: ScreenUtil().setSp(35),):Container(
                  ...
                  Text(index==0?'Tất Cả':'${danhMuc[index]['name']}',style: TextStyle(color:index==vitri?Colors.red:Colors.blueGrey,fontSize: ScreenUtil().setSp(13,allowFontScalingSelf: true)),textAlign: TextAlign.center,)
                ],
              ),
            ),
          ),
